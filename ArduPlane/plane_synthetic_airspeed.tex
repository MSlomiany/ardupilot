...
\author{AI-assisted repository analysis}
\date{}
...
\begin{itemize}
    \item \texttt{/home/runner/work/ardupilot/ardupilot/ArduPlane/system.cpp}
    \item \texttt{/home/runner/work/ardupilot/ardupilot/ArduPlane/Plane.cpp}
    \item \texttt{/home/runner/work/ardupilot/ardupilot/libraries/AP\_AHRS/AP\_AHRS.cpp}
    \item \texttt{/home/runner/work/ardupilot/ardupilot/libraries/AP\_AHRS/AP\_AHRS\_DCM.cpp}
    \item \texttt{/home/runner/work/ardupilot/ardupilot/libraries/AP\_TECS/AP\_TECS.cpp}
    \item \texttt{/home/runner/work/ardupilot/ardupilot/libraries/AP\_Baro/AP\_Baro\_atmosphere.cpp}
\end{itemize}
...
Let $V_g$ be ground speed magnitude. Then:
\begin{align}
...
If that condition is false, or if AHRS does not return a fresh estimate, TECS falls back to:
\begin{equation}
V_{EAS} \leftarrow \operatorname{constrain}(V_{\text{cruise}}, V_{\min}, V_{\max})
\end{equation}
...
\begin{equation}
\dot{V}_x \approx R_{31}\,g + a_x
\end{equation}
where $R_{31}$ is the forward-axis gravity projection from the body-to-NED rotation matrix, and $a_x$ is measured body-axis acceleration.
